...
<html lang="en"> 
    <head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        ...
        <!-- Bootstrap CSS -->
        <?= ($settings['theme'] == 'default')? '<link rel="stylesheet" href="//stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">': '';?>
        <!-- Bootswatch Themes -->
        <?= ($settings['theme'] != 'default')? '<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootswatch/4.3.1/'.$settings['theme'].'/bootstrap.min.css">': '';?>
        <!-- Font Awesome -->
        <link rel="stylesheet" href="//use.fontawesome.com/releases/v5.11.2/css/all.css">
        <link rel="stylesheet" href="//use.fontawesome.com/releases/v5.11.2/css/v4-shims.css">
        <!-- Base CSS -->
        <link rel="stylesheet" href="libs/css/base.css?v=<?= time();?>">	
        <style><?= $settings['css'];?>
        </style>
    </head>
    ...
    <body class="d-flex flex-column">
            ...
            <div class="container text-center">
                <div class="col-12 col-md-6 col-lg-7 float-md-left">
                    <div class="text-center text-md-left">
                        Copyright&copy; 2019<?= (date('Y')>2019)? date('Y'):'';?> <a href="<?= $settings['domain'];?>"><?= $settings['name'];?></a>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-5 float-md-right">
                    <div class="text-center text-md-right">
                        Powered by <a href="https://gr8.cc" target="_blank">GR8 Scripts</a>
                    </div>
                </div>
            </div>
        </footer>
        ...
        <script type="text/javascript" src="libs/show_ads.js?v=<?= time();?>"></script>
